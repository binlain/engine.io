...
Socket.prototype.setTransport = function (transport) {
  ...
  this.transport.on('drain', this._flush.bind(this));
...
/**
 * Flushes the packet buffer on the next tick.
 *
 * @api private
 */
...
Socket.prototype.flush = function () {
  if(!this.flushTimer) {
    this.flushTimer = setImmediate(this._flush.bind(this));
  }
};

Socket.prototype._flush = function(){
  this.flushTimer = null;
  if ('closed' != this.readyState && 'closing' != this.readyState && this.transport.writable
